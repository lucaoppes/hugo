export const artefacts = [
	...
	},
	{
		...
		description: `For his countless unspeakable crimes and attempting to start an intergalactic war, Little Petey was incarcerated for eternity in this cute glass bottle. He gets annoyed if you shake him, but he deserves it.`,
		image: '',
		price: 35,
		available: true
	},
	{
		...
		description: `Painstakingly crafted by the Seamstress Witches of the damp-moss kingdoms of old, these artisan scissors bestow whatever is cut by them a brand new set of eyes and, judging by how they stare, presumably sentience. Frankly, they caused nothing but hassle ever since they were invented and the Seamstress Witches were glad to be rid of them. But you'll probably love them!`,
		image: '',
		price: 79.99,
		available: true
	},
	{
		...
		description: `One day, when a Baking Sorcerer was making his usual daily batch of living sentient bagels to be enjoyed by all residents of Bakery Bay young and old, a bee managed to get itself trapped inside of his magical bewitching oven and transformed the batch into living Bee/Bagel Hybrids! The Sorcerer, deeming them far too adorable to be eaten, set them free! Unfortunately, they immediately began stinging and mildly irritating the public. All except one. This brave little Bagel Bee used his Sesame Stinger to hunt down his Sinister Siblings and bring them to justice. All the Bagel Bees and the Baking Sorcerer, riddled with stings, were locked away in a dungeon, forever. The Sorcerer wailed between Bagel Bee jabs: "This seems (ow) like a disproportionally (ow) harsh punishment for me. (ow) I didn't even get a trial." Thankfully, his cries were ignored. \n Bagel Bee, dubbed saviour of Bakery Bay, was anointed mayor. Most of his policies revolved around pushing honey and cream cheese production. Turns out he wasn't a great politician. His good nature and pollen/fresh bread scent make him the perfect household pet. He'll sting for you!`,
		image: '',
		price: 4.5,
		available: true
	},
	{
		...
		description: `After aeons of research, Tachyon Lab Group managed to create this dimension’s first ever cyborg rat, converting its normally inaudible sounds into audible human frequency. They soon learned about the creature's extreme dissatisfaction with its fate, as well as the converter's true potency, delivering massive concussive force every time it was used. \n Tachyon Labs is no longer in operation, or able to be pinpointed on a map, meaning this specimen could be yours for a once-in-a-lifetime discount! With the world's loudest rat on your side, gone are the days of worrying about pesky bulletproof glass, or excess hearing ability.`,
		image: '',
		price: 33.34,
		available: true
	}
...
function matchingImagesLow(value) {
	const id = value[0].slice(-6, -4);

	const artefact = artefacts.find((value) => value.id == id);

	if (artefact) {
		artefact.image = value[1].default;
	}
}

Object.entries(imagesLow).forEach(matchingImagesLow);
